...
//Em seguida, vamos, verificar quais são as tabelas daquela base, lista-las, e em um laço for, vamos mostrar cada uma delas, 
//e resgatar as funções descriação da tabela, 
//para serem gravadas no arquivo sql mais adiante.
...
foreach ($res as $key => $value) {
    ...
    while ($lin = mysqli_fetch_row($res2)) {
        ...
        while ($r = mysqli_fetch_row($res3)) {
            ...
            //Agora vamos pegar cada dado do campo de cada tabela, e executar tarefas como, quebra de linha, 
            //substituição de aspas, espaços em branco, etc.
            // Deixando o arquivo confiável para ser importado em outro banco de dados.
...
//Caso não tenha a Classe ZipArchive no seu PHP então não delete o arquivo .sql gerado
